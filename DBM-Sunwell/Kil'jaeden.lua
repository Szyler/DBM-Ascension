...
local timerNextSoulbomb 		= mod:NewTargetTimer(10, 2146682)

local warnSoulrend 				= mod:NewSpellAnnounce(2146680, 2)
local timerNextSoulrend 		= mod:NewNextTimer(30, 2146680)
...
-- Archonisus
local warnSummonWildImps 		= mod:NewSpellAnnounce(2146676, 3)
local timerNextSummonWildImps 	= mod:NewNextTimer(30, 2146676)
