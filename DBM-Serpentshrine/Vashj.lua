...
mod:AddBoolOption("LootIcon", false)
mod:AddBoolOption("AimedIcon", false)
mod:AddBoolOption("ChargeYellOpt", true)
mod:AddBoolOption("AimedYellOpt", true)
mod:AddBoolOption("LootYellOpt", true)
