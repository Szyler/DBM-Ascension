...
-------------------------------
DBM = {
	Revision = ("$Revision: 5004 $"):sub(12, -3),
	Version = "5.04",
	DisplayVersion = "5.04", -- the string that is shown as version
	ReleaseRevision = 5004 -- the revision of the latest stable version that is available (for /dbm ver2)
}
