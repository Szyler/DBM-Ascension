...
-------------------------------
DBM = {
	Revision = ("$Revision: 5003 $"):sub(12, -3),
	Version = "5.03",
	DisplayVersion = "5.03", -- the string that is shown as version
	ReleaseRevision = 5003 -- the revision of the latest stable version that is available (for /dbm ver2)
}
