...
-------------------------------
DBM = {
	Revision = ("$Revision: 5002 $"):sub(12, -3),
	Version = "5.02",
	DisplayVersion = "5.02", -- the string that is shown as version
	ReleaseRevision = 5002 -- the revision of the latest stable version that is available (for /dbm ver2)
}
