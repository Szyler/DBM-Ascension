...
-------------------------------
DBM = {
	Revision = ("$Revision: 5005 $"):sub(12, -3),
	Version = "5.05",
	DisplayVersion = "5.05", -- the string that is shown as version
	ReleaseRevision = 5005 -- the revision of the latest stable version that is available (for /dbm ver2)
}
