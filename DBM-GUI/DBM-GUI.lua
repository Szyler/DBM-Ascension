...
do
	...
	local sounds = MixinSharedMedia3("sound", {
		...
		{sound = true,	text	= "Beware ENG",		value 	= "Interface\\AddOns\\DBM-Core\\sounds\\beware.ogg"},
		{sound = true,	text	= "Beware ENG",		value 	= "Sound\\Creature\\AlgalonTheObserver\\UR_Algalon_BHole01.wav"},
